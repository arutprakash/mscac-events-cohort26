...
The event introduces participants to Centre Island and the route toward Ward's Island, followed by free time for lunch, the beach, and optional activities.

## Schedule

| Time | Activity |
|---|---|
| 8:30 AM | Meet, check in, distribute tickets, and brief the group |
| 9:00 AM | Ferry to Centre Island |
| 9:20 AM | Arrive, orient the group, and regroup |
| 9:30-11:00 AM | Guided Centreville and gardens walk |
| 11:00 AM-12:00 PM | Boardwalk walk toward Ward's Island |
| 12:00-1:00 PM | Lunch: packed meal or island cafe |
| 1:00-2:30 PM | Beach time; optional bike, canoe, or lighthouse visit |
| 2:30 PM | Walk to the ferry dock |
| 3:00 PM | Ferry to the mainland |
| 3:20 PM | Event conclusion |
...
1. Confirm the date, rain date, ferry sailings, tour availability, route, accessibility, and cancellation terms.
2. Choose packed lunches or cafe service; collect dietary and allergy information.
3. Confirm whether optional activities require reservations, waivers, or extra payment.
4. Assign an event lead, registration/finance lead, route lead, rear marshal, and welfare lead.
5. Send participants the meeting point, schedule, clothing guidance, lunch details, emergency contact, and return procedure.
6. Reconfirm bookings and weather one week before the event; arrive by 8:15 AM on the day.
7. Conduct headcounts at check-in, island arrival, lunch departure, activity departure, and ferry boarding.
8. Reconcile spending and collect feedback within three business days.
...
- Ferry and walking tour bookings confirmed
- Lunch option and dietary requirements confirmed
- Optional activities and extra costs approved
- Accessibility, staffing, emergency, and cancellation plans approved
- Contingency reserve added to the final budget

## References

- [Ferry pricing](https://secure.toronto.ca/FerryTicketOnline/tickets2/index.jsp)
- [Ferry routes and schedules](https://www.toronto.ca/explore-enjoy/toronto-island-ferries/ferry-routes-schedules/)
- [Toronto Island Walking Tours](https://www.torontoislandwalkingtours.com/contact.html)
- [Source quote workbook](toronto-islands-quote.xlsx)
